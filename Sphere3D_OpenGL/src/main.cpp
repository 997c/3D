...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.use();
        lightingShader.setVec3("objectColor", glm::value_ptr(glm::vec3(1.0f, 0.5f, 0.31f)));
        lightingShader.setVec3("lightColor", glm::value_ptr(glm::vec3(1.0f, 1.0f, 1.0f)));
...
void mouse_callback(GLFWwindow* window, double xposIn, double yposIn) {
    ...
    camera.ProcessKeyboard(xoffset, yoffset);
}
